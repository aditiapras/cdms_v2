/*
  ...
  - Added the required column `phase` to the `Drum` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `drum` ADD COLUMN `phase` VARCHAR(10) NOT NULL,
